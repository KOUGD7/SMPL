...
//-------------------------------------------------------------------------------------------------------------------
	...
	//System.out.println(fun.getFunExp().getParameters());
...
//-------------------------------------------------------------------------------------------------------------------
	...
	FnPlotValue hi = exp.getHigh().visit(this, arg);
	FnPlotValue lo = exp.getLow().visit(this, arg);
	double h = hi.doubleValue();
	double l = lo.doubleValue();
	Exp f = exp.getFunc();
	String id = exp.getId();
