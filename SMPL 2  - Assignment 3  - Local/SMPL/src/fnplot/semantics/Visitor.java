...
public interface Visitor<S, T> {
    ...
    public T visitCase(ExpCase exp, S arg) throws FnPlotException;
   

    public T visitExpString(ExpString exp, S arg) throws FnPlotException;

  
    public T visitExpSubStr(ExpSubStr exp, S arg) throws FnPlotException;

    
    public T visitHeap(ExpHeap exp, S arg) throws FnPlotException;


    public T visitLoop(ExpLoop exp, S arg) throws FnPlotException;

    
    public T visitVecComp(ExpVecComp exp, S arg) throws FnPlotException;


    public T visitReadPrint(ExpReadPrint exp, S arg) throws FnPlotException;
