...
public abstract class FnPlotValue<T extends FnPlotValue<T>> {
    ...
    public static FnString make(String v) {
        return new FnString(v);
    }

    /**
     * Create a FnPlot value wrapping a Java Boolean
     * @param v the boolean value to be wrapped
     * @return The FnPlotValue instance to represent that double precision value
     */
    public static FnBool make(Boolean v) {
        return new FnBool(v);
    }
